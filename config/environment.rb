...
ENV['CLASSPATH'] = "#{RAILS_ROOT}/lib/java/:#{RAILS_ROOT}/lib/java/toxtree/toxTree/dist/Toxtree-1.60.jar:#{RAILS_ROOT}/vendor/plugins/opentox/lib/java/cdk-1.1.svn-19012008.jar"
